...
def showPlots(f_c, f_c_1, f_c_2, f, abs_h_f, abs_h_f_dB):
...
if(__name__=='__main__'):
    ...
    [f_c_1, f_c_2, f_c, f, abs_h_f, abs_h_f_dB] = calculate_frequency_magnitude_response(f_c, delta_f, transition_bandwidth, transition_bandwidth_stop_perc, abs_h_f_c_stop_dB)

    showPlots(f_c, f_c_1, f_c_2, f, abs_h_f, abs_h_f_dB)
